...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=2F80ED&center=true&vCenter=true&width=600&lines=Building+cool+things+with+code;Open+Source+Contributor;Always+learning+something+new" alt="Typing SVG" />
</p>
...
> Tip: swap the badges above to match your actual stack. Full badge library at https://simpleicons.org and https://shields.io.
...
Short one-line description of what it does and the impact/results (e.g. "Reduced API latency by 40% using caching").
`Tech: React, Node.js, MongoDB`

#### 🔹 [Project Name 2](https://github.com/YOUR_USERNAME/project-2)
Short one-line description of what it does and the impact/results.
...
- 🥇 [Hackathon/Competition Name] — Result, Year
- 📄 [Publication/Blog] — Platform, Year
